...
var wasTracked = function (dep) {
  return (dep.w & trackOpBit) > 0;
};
var newTracked = function (dep) {
  return (dep.n & trackOpBit) > 0;
};
var initDepMarkers = function (_ref) {
  var {
    deps
  } = _ref;
  if (deps.length) {
...
function triggerEffects(dep, debuggerEventExtraInfo) {
  ...
  var effects = (0,_vue_shared__WEBPACK_IMPORTED_MODULE_0__.isArray)(dep) ? dep : [...dep];
...
function warn(msg) {
  ...
  if (appWarnHandler) {
    ...
    var warnArgs = [`[Vue warn]: ${msg}`, ...args];
    /* istanbul ignore if */
    if (trace.length &&
...
function withDirectives(vnode, directives) {
  ...
  for (var i = 0; i < directives.length; i++) {
    var [dir, value, arg, modifiers = _vue_shared__WEBPACK_IMPORTED_MODULE_1__.EMPTY_OBJ] = directives[i];
    if (dir) {
  ...
  if (methods) {
    for (var _key5 in methods) {
      ...
      if ((0,_vue_shared__WEBPACK_IMPORTED_MODULE_1__.isFunction)(methodHandler)) {
        ...
        warn(`Method "${_key5}" has type "${typeof methodHandler}" in the component definition. ` + `Did you reference the function correctly?`);
      }
    }
  }
  if (dataOptions) {
  ...
  if (computedOptions) {
    var _loop3 = function (_key7) {
      ...
      if ( true && get === _vue_shared__WEBPACK_IMPORTED_MODULE_1__.NOOP) {
        warn(`Computed property "${_key7}" has no getter.`);
      }
      var set = !(0,_vue_shared__WEBPACK_IMPORTED_MODULE_1__.isFunction)(opt) && (0,_vue_shared__WEBPACK_IMPORTED_MODULE_1__.isFunction)(opt.set) ? opt.set.bind(publicThis) :  true ? function () {
        warn(`Write operation failed: computed property "${_key7}" is readonly.`);
      } : 0;
      var c = computed({
        get,
        set
  ...
  if ((0,_vue_shared__WEBPACK_IMPORTED_MODULE_1__.isString)(raw)) {
    ...
    if ((0,_vue_shared__WEBPACK_IMPORTED_MODULE_1__.isArray)(raw)) {
      ...
      if ((0,_vue_shared__WEBPACK_IMPORTED_MODULE_1__.isFunction)(_handler)) {
        ...
        warn(`Invalid watch handler specified by key "${raw.handler}"`, _handler);
      }
    }
  } else if (true) {
...
function getInvalidTypeMessage(name, value, expectedTypes) {
  var message = `Invalid prop: type check failed for prop "${name}".` + ` Expected ${expectedTypes.map(_vue_shared__WEBPACK_IMPORTED_MODULE_1__.capitalize).join(' | ')}`;
...
function baseCreateRenderer(options, createHydrationFns) {
  ...
  var moveStaticNode = function (_ref12, container, nextSibling) {
    var {
      el,
      anchor
    } = _ref12;
  ...
  var removeStaticNode = function (_ref13) {
    var {
      el,
      anchor
    } = _ref13;
      ...
      if (disabled) {
        ...
        if ((n2.props && n2.props.to) !== (n1.props && n1.props.to)) {
          ...
          if (nextTarget) {
            ...
            warn('Invalid Teleport target on update:', _target, `(${typeof _target})`);
          }
        } else if (wasDisabled) {
          // disabled -> enabled
...
var normalizeKey = function (_ref18) {
  var {
    key
  } = _ref18;
  return key != null ? key : null;
};
var normalizeRef = function (_ref19) {
  var {
    ref,
    ref_key,
    ref_for
...
var warnRuntimeUsage = function (method) {
  return warn(`${method}() is a compiler-hint helper that is only usable inside ` + `<script setup> of a single file component. Its arguments should be ` + `compiled away and passing it at runtime has no effect.`);
};
// implementation
...
class VueElement extends BaseClass {
  ...
  _resolveDef() {
    ...
    new MutationObserver(function (mutations) {
      for (var m of mutations) {
        _this2._setAttr(m.attributeName);
      }
    }).observe(this, {
      attributes: true
    });
      ...
      if (props && !(0,_vue_shared__WEBPACK_IMPORTED_MODULE_1__.isArray)(props)) {
        for (var key in props) {
          ...
          if (opt === Number || opt && opt.type === Number) {
            if (key in _this2._props) {
              _this2._props[key] = (0,_vue_shared__WEBPACK_IMPORTED_MODULE_1__.toNumber)(_this2._props[key]);
            }
            (numberProps || (numberProps = Object.create(null)))[(0,_vue_shared__WEBPACK_IMPORTED_MODULE_1__.camelize)(key)] = true;
          }
        }
      }
      _this2._numberProps = numberProps;
      if (isAsync) {
        // defining getter/setters on prototype
        // for sync defs, this already happened in the constructor
        _this2._resolveProps(def);
      }
      // apply CSS
      _this2._applyStyles(styles);
      // initial render
      _this2._update();
    };
  ...
  _resolveProps(def) {
    ...
    var _loop = function (_key2) {
      Object.defineProperty(_this3, _key2, {
        get() {
          return this._getProp(_key2);
        },
        set(val) {
          this._setProp(_key2, val);
        }
      });
    };
    for (var _key2 of declaredPropKeys.map(_vue_shared__WEBPACK_IMPORTED_MODULE_1__.camelize)) {
      _loop(_key2);
    }
  }
  _setAttr(key) {
...
var Transition = function (props, _ref) {
  var {
    slots
  } = _ref;
...
function getTimeout(delays, durations) {
  ...
  return Math.max(...durations.map(function (d, i) {
...
var createSSRApp = function () {
  var app = ensureHydrationRenderer().createApp(...arguments);
  if (true) {
    injectNativeTagCheck(app);
    injectCompilerOptionsCheck(app);
  }
...
var replacer = function (_key, val) {
  ...
  if (val && val.__v_isRef) {
    ...
    return {
      [`Map(${val.size})`]: [...val.entries()].reduce(function (entries, _ref) {
        var [key, val] = _ref;
        entries[`${key} =>`] = val;
        return entries;
      }, {})
...
var _hoisted_1 = /*#__PURE__*/(0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("h1", null, "标题", -1 /* HOISTED */);
var _hoisted_2 = /*#__PURE__*/(0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("p", null, "内容", -1 /* HOISTED */);
var _hoisted_3 = /*#__PURE__*/(0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("button", null, "操作按钮", -1 /* HOISTED */);
var _hoisted_4 = /*#__PURE__*/(0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("button", null, "操作按钮", -1 /* HOISTED */);
...
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _assets_css_div_css__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ../assets/css/div.css */ "./src/assets/css/div.css");
/* harmony import */ var _assets_css_title_less__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ../assets/css/title.less */ "./src/assets/css/title.less");
/* harmony import */ var _assets_css_bg_css__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ../assets/css/bg.css */ "./src/assets/css/bg.css");
/* harmony import */ var _assets_images_bear_jpg__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ../assets/images/bear.jpg */ "./src/assets/images/bear.jpg");
...
imgEl.src = _assets_images_bear_jpg__WEBPACK_IMPORTED_MODULE_3__;
...
/***/ "./node_modules/css-loader/dist/cjs.js!./node_modules/less-loader/dist/cjs.js!./node_modules/postcss-loader/dist/cjs.js!./src/assets/css/title.less":
/*!**********************************************************************************************************************************************************!*\
  !*** ./node_modules/css-loader/dist/cjs.js!./node_modules/less-loader/dist/cjs.js!./node_modules/postcss-loader/dist/cjs.js!./src/assets/css/title.less ***!
  \**********************************************************************************************************************************************************/
...
// Module
___CSS_LOADER_EXPORT___.push([module.id, ".title {\n  -webkit-user-select: none;\n  -moz-user-select: none;\n  user-select: none;\n  color: #999999;\n}\n", "",{"version":3,"sources":["webpack://./src/assets/css/title.less"],"names":[],"mappings":"AAAA;EACE,yBAAA;EACG,sBAAA;EACK,iBAAA;EACR,cAAA;AACF","sourcesContent":[".title {\n  -webkit-user-select: none;\n     -moz-user-select: none;\n          user-select: none;\n  color: #999999;\n}\n"],"sourceRoot":""}]);
// Exports
...
/***/ "./node_modules/css-loader/dist/cjs.js!./node_modules/postcss-loader/dist/cjs.js!./src/assets/css/bg.css":
/*!***************************************************************************************************************!*\
  !*** ./node_modules/css-loader/dist/cjs.js!./node_modules/postcss-loader/dist/cjs.js!./src/assets/css/bg.css ***!
  \***************************************************************************************************************/
/***/ (function(module, __webpack_exports__, __webpack_require__) {
...
var ___CSS_LOADER_URL_IMPORT_0___ = new URL(/* asset import */ __webpack_require__(/*! ../images/sleep.png */ "./src/assets/images/sleep.png"), __webpack_require__.b);
var ___CSS_LOADER_EXPORT___ = _node_modules_css_loader_dist_runtime_api_js__WEBPACK_IMPORTED_MODULE_1___default()((_node_modules_css_loader_dist_runtime_sourceMaps_js__WEBPACK_IMPORTED_MODULE_0___default()));
var ___CSS_LOADER_URL_REPLACEMENT_0___ = _node_modules_css_loader_dist_runtime_getUrl_js__WEBPACK_IMPORTED_MODULE_2___default()(___CSS_LOADER_URL_IMPORT_0___);
// Module
___CSS_LOADER_EXPORT___.push([module.id, ".bg {\r\n  width: 400px;\r\n  height: 400px;\r\n  background: url(" + ___CSS_LOADER_URL_REPLACEMENT_0___ + ");\r\n}\r\n", "",{"version":3,"sources":["webpack://./src/assets/css/bg.css"],"names":[],"mappings":"AAAA;EACE,YAAY;EACZ,aAAa;EACb,mDAAsC;AACxC","sourcesContent":[".bg {\r\n  width: 400px;\r\n  height: 400px;\r\n  background: url('../images/sleep.png');\r\n}\r\n"],"sourceRoot":""}]);
// Exports
/* harmony default export */ __webpack_exports__["default"] = (___CSS_LOADER_EXPORT___);
...
/***/ "./node_modules/css-loader/dist/cjs.js!./node_modules/postcss-loader/dist/cjs.js!./src/assets/css/div.css":
/*!****************************************************************************************************************!*\
  !*** ./node_modules/css-loader/dist/cjs.js!./node_modules/postcss-loader/dist/cjs.js!./src/assets/css/div.css ***!
  \****************************************************************************************************************/
/***/ (function(module, __webpack_exports__, __webpack_require__) {
...
var ___CSS_LOADER_EXPORT___ = _node_modules_css_loader_dist_runtime_api_js__WEBPACK_IMPORTED_MODULE_1___default()((_node_modules_css_loader_dist_runtime_sourceMaps_js__WEBPACK_IMPORTED_MODULE_0___default()));
// Module
___CSS_LOADER_EXPORT___.push([module.id, ".content {\r\n  font-size: 18px;\r\n  color: red;\r\n  background-color: rgba(102,102,102,0.4);\r\n  -webkit-user-select: none;\r\n     -moz-user-select: none;\r\n          user-select: none;\r\n}\r\n", "",{"version":3,"sources":["webpack://./src/assets/css/div.css"],"names":[],"mappings":"AAAA;EACE,eAAe;EACf,UAAU;EACV,uCAA2B;EAC3B,yBAAiB;KAAjB,sBAAiB;UAAjB,iBAAiB;AACnB","sourcesContent":[".content {\r\n  font-size: 18px;\r\n  color: red;\r\n  background-color: #66666666;\r\n  user-select: none;\r\n}\r\n"],"sourceRoot":""}]);
// Exports
/* harmony default export */ __webpack_exports__["default"] = (___CSS_LOADER_EXPORT___);
...
/* harmony import */ var _node_modules_style_loader_dist_runtime_styleTagTransform_js__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! !../../../node_modules/style-loader/dist/runtime/styleTagTransform.js */ "./node_modules/style-loader/dist/runtime/styleTagTransform.js");
/* harmony import */ var _node_modules_style_loader_dist_runtime_styleTagTransform_js__WEBPACK_IMPORTED_MODULE_5___default = /*#__PURE__*/__webpack_require__.n(_node_modules_style_loader_dist_runtime_styleTagTransform_js__WEBPACK_IMPORTED_MODULE_5__);
/* harmony import */ var _node_modules_css_loader_dist_cjs_js_node_modules_postcss_loader_dist_cjs_js_bg_css__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! !!../../../node_modules/css-loader/dist/cjs.js!../../../node_modules/postcss-loader/dist/cjs.js!./bg.css */ "./node_modules/css-loader/dist/cjs.js!./node_modules/postcss-loader/dist/cjs.js!./src/assets/css/bg.css");
...
var update = _node_modules_style_loader_dist_runtime_injectStylesIntoStyleTag_js__WEBPACK_IMPORTED_MODULE_0___default()(_node_modules_css_loader_dist_cjs_js_node_modules_postcss_loader_dist_cjs_js_bg_css__WEBPACK_IMPORTED_MODULE_6__["default"], options);




       /* harmony default export */ __webpack_exports__["default"] = (_node_modules_css_loader_dist_cjs_js_node_modules_postcss_loader_dist_cjs_js_bg_css__WEBPACK_IMPORTED_MODULE_6__["default"] && _node_modules_css_loader_dist_cjs_js_node_modules_postcss_loader_dist_cjs_js_bg_css__WEBPACK_IMPORTED_MODULE_6__["default"].locals ? _node_modules_css_loader_dist_cjs_js_node_modules_postcss_loader_dist_cjs_js_bg_css__WEBPACK_IMPORTED_MODULE_6__["default"].locals : undefined);


/***/ }),

/***/ "./src/assets/css/div.css":
/*!********************************!*\
  !*** ./src/assets/css/div.css ***!
  \********************************/
/***/ (function(__unused_webpack_module, __webpack_exports__, __webpack_require__) {
...
/* harmony import */ var _node_modules_style_loader_dist_runtime_styleTagTransform_js__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! !../../../node_modules/style-loader/dist/runtime/styleTagTransform.js */ "./node_modules/style-loader/dist/runtime/styleTagTransform.js");
/* harmony import */ var _node_modules_style_loader_dist_runtime_styleTagTransform_js__WEBPACK_IMPORTED_MODULE_5___default = /*#__PURE__*/__webpack_require__.n(_node_modules_style_loader_dist_runtime_styleTagTransform_js__WEBPACK_IMPORTED_MODULE_5__);
/* harmony import */ var _node_modules_css_loader_dist_cjs_js_node_modules_postcss_loader_dist_cjs_js_div_css__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! !!../../../node_modules/css-loader/dist/cjs.js!../../../node_modules/postcss-loader/dist/cjs.js!./div.css */ "./node_modules/css-loader/dist/cjs.js!./node_modules/postcss-loader/dist/cjs.js!./src/assets/css/div.css");
...
var update = _node_modules_style_loader_dist_runtime_injectStylesIntoStyleTag_js__WEBPACK_IMPORTED_MODULE_0___default()(_node_modules_css_loader_dist_cjs_js_node_modules_postcss_loader_dist_cjs_js_div_css__WEBPACK_IMPORTED_MODULE_6__["default"], options);




       /* harmony default export */ __webpack_exports__["default"] = (_node_modules_css_loader_dist_cjs_js_node_modules_postcss_loader_dist_cjs_js_div_css__WEBPACK_IMPORTED_MODULE_6__["default"] && _node_modules_css_loader_dist_cjs_js_node_modules_postcss_loader_dist_cjs_js_div_css__WEBPACK_IMPORTED_MODULE_6__["default"].locals ? _node_modules_css_loader_dist_cjs_js_node_modules_postcss_loader_dist_cjs_js_div_css__WEBPACK_IMPORTED_MODULE_6__["default"].locals : undefined);
...
/* harmony import */ var E_FrontEnd_webpack_node_modules_vue_loader_dist_exportHelper_js__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./node_modules/vue-loader/dist/exportHelper.js */ "./node_modules/vue-loader/dist/exportHelper.js");




;
const __exports__ = /*#__PURE__*/(0,E_FrontEnd_webpack_node_modules_vue_loader_dist_exportHelper_js__WEBPACK_IMPORTED_MODULE_2__["default"])(_App_vue_vue_type_script_lang_js__WEBPACK_IMPORTED_MODULE_1__["default"], [['render',_App_vue_vue_type_template_id_7ba5bd90__WEBPACK_IMPORTED_MODULE_0__.render],['__file',"src/App.vue"]])
/* hot reload */
if (false) {}
...
module.exports = __webpack_require__.p + "imges/bear_422ff82778e8e70eca21.jpg";
...
/*!*********************!*\
  ...
  \*********************/
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _utils_add_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./utils/add.js */ "./src/utils/add.js");
/* harmony import */ var _components_createDom_js__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! @/components/createDom.js */ "./src/components/createDom.js");
...
(0,vue__WEBPACK_IMPORTED_MODULE_2__.createApp)(_App__WEBPACK_IMPORTED_MODULE_3__["default"]).mount('#app');
var res = (0,_utils_add_js__WEBPACK_IMPORTED_MODULE_0__.add)(10, 20);
console.log('res', res);
console.log('res', res);
console.log('res', res);
var message = 'message';
